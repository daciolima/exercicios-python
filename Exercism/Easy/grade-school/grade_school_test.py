...
class GradeSchoolTest(unittest.TestCase):
    ...
    def test_adicionar_um_aluno_na_lista_classificada(self):
        school = School()
    ...
    def test_adicionar_mais_alunos_adicionar_na_lista_classificada_retornando_ordem_alfabetica(self):
        school = School()
    ...
    def test_adicionar_alunos_na_series_diferentes_e_adicionar_na_mesma_lista_classificada(self):
        school = School()
    ...
    def test_retorna_uma_lista_vazia_se_nao_houver_alunos_matriculados(self):
        school = School()
        expected = []
        self.assertEqual(school.roster(), expected)

    # def test_student_names_with_grades_are_displayed_in_the_same_sorted_roster(self):
    def test_nomes_de_alunos_com_notas_sao_exibidos_na_mesma_lista_classificada(self):
        school = School()
    ...
    def test_nota_retorna_os_alunos_daquela_serie_em_ordem_alfabetica(self):
        school = School()
    ...
    def test_retorna_uma_lista_vazia_se_nao_houver_alunos_na_serie(self):
        school = School()
        expected = []
